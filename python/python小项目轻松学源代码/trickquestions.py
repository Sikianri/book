"""技巧问题，作者：Al Sweigart al@inventwithpython.com
几个技巧问题的测验。
...
# QUESTIONS 是一个字典列表，每个字典代表一个
# 技巧问题及其答案。 字典有键“问题”
#（保存问题的文本），'answer'（保存文本
# 的答案）和“接受”（其中包含一个字符串列表，如果
# 玩家的答案包含其中任何一项，他们已正确回答）。
# (!) 试着想出你自己的技巧问题添加到这里：
QUESTIONS = [
...
for questionNumber, qa in enumerate(QUESTIONS):  # 主程序循环。
    print('\n' * 40)  # “清除”屏幕。
